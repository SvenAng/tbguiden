 ...
 * Content menu.
 */
function tbguiden_menu_tree__menu_block__8($variables) {
   return '<ul class="content-menu">' . $variables['tree'] . '</ul>';
 }
/**
 * Level 2 menu. Den mörkblåa
 */
function tbguiden_menu_tree__menu_block__6($variables) {
   return '<ul class="level2-menu">' . $variables['tree'] . '</ul>';
 }
 /**
 * Level 3 menu. Den som ligger ovanför artikel
 */
 function tbguiden_menu_tree__menu_block__9($variables) {
   return '<ul class="level3-menu">' . $variables['tree'] . '</ul>';
 }
/**
 * Implements template_preprocess_page.
 */

function tbguiden_menu_link(array $variables) {
...
function tbguiden_preprocess_page(&$variables) {
